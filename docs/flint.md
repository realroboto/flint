...
| "Never drop a negation or quantifier — not/never/no/only/except flip meaning… Numbers and units exact." | caveman #670 (v1.10.0) | aggressive compression dropped a negation and inverted the instruction — a correctness bug, not a style slip; the harder the terseness push, the higher the risk |
